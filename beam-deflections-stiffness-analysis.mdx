...
1. <Badge text="Calculate" variant="tip" /> beam deflections using integration methods and standard formulas
2. <Badge text="Apply" variant="note" /> superposition principles for complex loading conditions
3. <Badge text="Determine" variant="caution" /> maximum deflections and slopes in CNC spindle systems
4. <Badge text="Design" variant="tip" /> beams to meet both strength and stiffness requirements
