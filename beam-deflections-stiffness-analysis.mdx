...
- Radial cutting force: 2000 N at tool tip
...
1. **Hollow circular cross-section:**
   ...
   <details>
   <summary>**Click to reveal cross-section dimensions**</summary>
...
1. **Deflection from point load at tip:**
   ...
   <details>
   <summary>**Click to reveal point load deflection calculation**</summary>
...
2. **Deflection from distributed tool weight:**
   ...
   <details>
   <summary>**Click to reveal distributed load deflection calculation**</summary>
...
3. **Total overhang deflection:**
   ...
   <details>
   <summary>**Click to reveal total overhang deflection**</summary>
...
### Step 5: Total System Deflection
