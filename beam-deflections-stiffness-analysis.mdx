...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![PCB Standoff Simply Supported](https://pub-b1eb899abc464b5baf5b9521d163efd9.r2.dev/solid-mechanics/fixed-fixed-udl-beam.png)
  </TailwindWrapper>
</div>
**Given:**
...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![C-Arm Cantilever Configuration](https://pub-b1eb899abc464b5baf5b9521d163efd9.r2.dev/solid-mechanics/mobile-c-arm-fluoroscopy-system.webp)
  </TailwindWrapper>
</div>
**What we need to analyze:**
...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![Mobile C-Arm Fluoroscopy System Fixed-free Supported](https://pub-b1eb899abc464b5baf5b9521d163efd9.r2.dev/solid-mechanics/fixed-free-point-load-c-arm-fluoroscopy-system.png)
  </TailwindWrapper>
</div>
**Given:**
...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![CNC Gantry Rail Simply Supported](https://pub-b1eb899abc464b5baf5b9521d163efd9.r2.dev/solid-mechanics/CNC-machine-gantry-rail.png)
  </TailwindWrapper>
</div>
**What we need to analyze:**
...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![Simply Supported Point Load Beam](https://pub-b1eb899abc464b5baf5b9521d163efd9.r2.dev/solid-mechanics/gantry-rail-loading-diagram.png)
  </TailwindWrapper>
</div>
**Given:**
...
- <Badge text="Support configuration is paramount" variant="tip" /> Fixed-fixed (4-5× stiffer) >> Simply supported (16× stiffer) >> Cantilever
...
- <Badge text="Application-specific limits" variant="note" /> PCBs: L/100, C-arms: L/1200-L/2400, CNC: L/1000, Structural: L/250
