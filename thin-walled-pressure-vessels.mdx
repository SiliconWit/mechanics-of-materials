...
1. <Badge text="Calculate" variant="tip" /> hoop and longitudinal stresses in cylindrical pressure vessels
2. <Badge text="Design" variant="note" /> wall thickness for pneumatic actuator casings
3. <Badge text="Apply" variant="caution" /> safety factors and failure criteria for pressurized systems
4. <Badge text="Analyze" variant="tip" /> stress concentrations around openings and joints
