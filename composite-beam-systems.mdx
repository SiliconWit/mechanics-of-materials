...
**Hybrid CNC Machine Bed Cross-Section**

**Geometry:**
- Steel I-beam reinforcement: 150 mm × 200 mm × 12 mm (flanges), 8 mm web
- Aluminum casting around steel: 300 mm wide × 250 mm tall
- Span length: 2000 mm (simply supported for analysis)
- Applied load: 50 kN uniform distributed load

**Material Properties:**
- Steel: E₁ = 200 GPa, σ_yield = 250 MPa  
- Aluminum: E₂ = 70 GPa, σ_yield = 140 MPa
:::
...
1. **Choose aluminum as reference material** (softer, E₂ = 70 GPa):
   $$n = \frac{E_{steel}}{E_{aluminum}} = \frac{200}{70} = 2.86$$

2. **Transform steel section** to equivalent aluminum:
   - Steel I-beam actual width dimensions: 150 mm flanges, 8 mm web
   - Steel I-beam transformed: 150 × 2.86 = 429 mm flanges, 8 × 2.86 = 23 mm web

3. **Verify approach:** We'll analyze the transformed section as all-aluminum, then convert steel stresses back using the transformation ratio.

</Steps>

### Step 2: Locate Neutral Axis of Transformed Section

**Transformed cross-section components:**

**Aluminum region** (original):
- Total area minus steel: A₁ = (300×250) - (150×200-8×176) = 75,000 - 28,592 = 46,408 mm²
- Centroid from bottom: ȳ₁ ≈ 125 mm (approximate due to steel cutout)

**Steel region** (transformed to aluminum):
- Transformed area: A₂ = 28,592 mm² (actual steel area, same as removed aluminum)
...
:::note[Symmetric Section]
For this symmetric composite section, the neutral axis is at the geometric center (125 mm from bottom).
:::
...
This requires detailed calculation of the composite I-beam within aluminum casting. For this problem, let's use:
$$I_{transformed} = 2.1 \times 10^8 \text{ mm}^4$$

### Step 5: Calculate Stresses in Each Material

<Steps>

1. **Maximum distance from neutral axis:**
   - c = 125 mm (to top or bottom fiber)

2. **Stress in aluminum regions:**
   $$\sigma_{aluminum} = \frac{My}{I} = \frac{25,000 \times 10^3 \times 125}{2.1 \times 10^8} = 14.9 \text{ MPa}$$

3. **Stress in steel regions:**
   $$\sigma_{steel} = n \times \sigma_{aluminum} = 2.86 \times 14.9 = 42.6 \text{ MPa}$$

4. **Safety factor check:**
   - Aluminum: SF = 140/14.9 = 9.4 ✅
   - Steel: SF = 250/42.6 = 5.9 ✅
...
<CardGrid>
  ...
  <Card title="Load Distribution" icon="information">
    **Steel carries:** 2.86× more stress per unit strain  
    **Aluminum provides:** Bulk material and mounting surfaces  
    **Efficiency:** <Badge text="Optimal material usage" variant="tip" />
  </Card>
</CardGrid>
