...
- Support: Fixed at base (cantilever configuration)
...
1. **Sum of vertical forces:**
   ...
   <details>
   <summary>**Click to reveal force equilibrium calculations**</summary>
...
2. **Sum of moments about base:**
   ...
   <details>
   <summary>**Click to reveal moment equilibrium calculations**</summary>
...
3. **Verify equilibrium:**
   ...
   <details>
   <summary>**Click to reveal equilibrium verification**</summary>
...
2. **Maximum moment location:**
   ...
   <details>
   <summary>**Click to reveal moment location analysis**</summary>
