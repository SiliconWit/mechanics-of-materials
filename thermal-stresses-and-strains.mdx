...
1. <Badge text="Calculate" variant="tip" /> thermal expansion and contraction in heated components
2. <Badge text="Analyze" variant="note" /> thermal stress development in constrained systems
3. <Badge text="Apply" variant="caution" /> thermal stress principles to piston-cylinder interfaces
4. <Badge text="Design" variant="tip" /> for thermal expansion in mechatronic systems
...
<CardGrid>
  <Card title="Thermal Expansion" icon="information">
    ...
    **Status:** <Badge text="Aluminum expands 2× more" variant="note" />
  </Card>
  <Card title="Operating Clearances" icon="approve">
    **Cold clearance:** 0.05 mm  
    **Hot clearance:** 0.092 mm  
    **Design clearance:** 0.092 mm cold  
    **Status:** <Badge text="Adequate clearance maintained" variant="success" />
  </Card>
  <Card title="Thermal Stress" icon="error">
    ...
    **Status:** <Badge text="Must allow free expansion" variant="caution" />
  </Card>
</CardGrid>
