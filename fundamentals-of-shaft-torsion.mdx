...
1. <Badge text="Calculate" variant="tip" /> torsional shear stresses in circular crankshafts
2. <Badge text="Determine" variant="note" /> angular deformation (twist) in rotating shafts
3. <Badge text="Apply" variant="caution" /> torsion theory to Geneva mechanism analysis
4. <Badge text="Design" variant="tip" /> shafts for both strength and stiffness requirements
