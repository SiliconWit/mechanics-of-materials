---
title: "Lesson 5: Torsion of Circular Shafts"
...
- Length: 200 mm
- Safety factor: 3.0
- Motor torque: 50 N·m (continuous)
- Peak torque: 150 N·m (during engagement)
...
1. **Continuous operation stress:**
   ...
   <details>
   <summary>**Click to reveal continuous stress calculation**</summary>
...
2. **Peak engagement stress:**
   ...
   <details>
   <summary>**Click to reveal peak stress calculation**</summary>
...
<CardGrid>
  <Card title="Original Design (25 mm)" icon="error">
    ...
    **Safety Factor:** 0.37  
    **Angular Twist:** 40.8°  
    **Status:** <Badge text="Fails both criteria" variant="danger" />
  </Card>
  <Card title="Strength Design (35 mm)" icon="warning">
    **Shear Stress:** 176 MPa  
    **Safety Factor:** 3.0  
    **Angular Twist:** 14.6°  
    **Status:** <Badge text="Strong but too flexible" variant="caution" />
  </Card>
  <Card title="Final Design (50 mm)" icon="approve">
    **Shear Stress:** 61 MPa  
    **Safety Factor:** 8.9  
    **Angular Twist:** 0.49°  
    **Status:** <Badge text="Meets all requirements" variant="success" />
  </Card>
</CardGrid>
...
**Key Design Insight:** <Badge text="Stiffness often governs shaft design more than strength" variant="note" />
...
**Coming Next**: In Lesson 6, we'll analyze thin-walled pressure vessels in pneumatic actuator casings, exploring how internal pressure creates both hoop and longitudinal stresses in cylindrical components.
