...
1. **Position 1: Print head at left quarter-point (x = 300 mm)**
   ...
   <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
     <TailwindWrapper>
       ![Load at Quarter Point](https://pub-b1eb899abc464b5baf5b9521d163efd9.r2.dev/solid-mechanics/gantry-position-1-quarter.png)
     </TailwindWrapper>
   </div>
...
2. **Position 2: Print head at midspan (x = 600 mm)**
   ...
   <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
     <TailwindWrapper>
       ![Load at Midspan](https://pub-b1eb899abc464b5baf5b9521d163efd9.r2.dev/solid-mechanics/gantry-position-2-midspan.png)
     </TailwindWrapper>
   </div>
...
3. **Position 3: Print head at right quarter-point (x = 900 mm)**
   ...
   <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
     <TailwindWrapper>
       ![Load at Right Quarter](https://pub-b1eb899abc464b5baf5b9521d163efd9.r2.dev/solid-mechanics/gantry-position-3-right-quarter.png)
     </TailwindWrapper>
   </div>
