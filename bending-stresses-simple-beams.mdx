...
- Object contact: Additional distributed reaction
...
2. **Calculate maximum moment:**
   ...
   <details>
   <summary>**Click to reveal moment calculation**</summary>
   
   $$M_{max} = F \times L = 500 \times 0.08 = 40 \text{ N·m}$$
   
   </details>

3. **Verify using Lesson 2.1 knowledge:**
   
   <details>
   <summary>**Click to reveal verification**</summary>
   
   From shear force and moment diagrams, we know the moment increases linearly from 0 at the tip to maximum at the support. ✅
...
1. **Apply flexural formula:**
   ...
   <details>
   <summary>**Click to reveal flexural formula calculation**</summary>
   
   $$\sigma_{max} = \frac{M \cdot c}{I} = \frac{40 \times 4 \times 10^{-3}}{640 \times 10^{-12}} = 250 \times 10^6 \text{ Pa} = 250 \text{ MPa}$$
   
   </details>

2. **Alternative calculation using section modulus:**
   
   <details>
   <summary>**Click to reveal section modulus method**</summary>
...
**Required maximum stress** with SF = 3.0:
...
**For rectangular section with width = 15 mm:**
