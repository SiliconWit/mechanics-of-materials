...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![Gantry Rail Shear Force Diagram](./codes/lesson-2-2/gantry_rail_shear_diagram.svg)
  </TailwindWrapper>
</div>

<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![Gantry Rail Bending Moment Diagram](./codes/lesson-2-2/gantry_rail_moment_diagram.svg)
  </TailwindWrapper>
</div>
