...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![Cantilever Robotic Gripper Jaw](./codes/crane_jib_beam_diagram.png)
  </TailwindWrapper>
</div>
...
1. **Calculate shear forces at critical points:**

   - At x = 0 (point A): V = +3167 N
   - Just before P₁ (x = 1.5⁻): V = 3167 - 800(1.5) = 1967 N
   - Just after P₁ (x = 1.5⁺): V = 1967 - 7000 = -5033 N
   - Just before B (x = 3.0⁻): V = -5033 - 800(1.5) = -6233 N
   - Just after B (x = 3.0⁺): V = -6233 + 11233 = 5000 N
   - At overhang end (x = 4.0): V = 5000 - 800(1.0) - 4200 = 0 ✅
...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![Cantilever Robotic Gripper Jaw](./codes/crane_jib_shear_diagram.png)
  </TailwindWrapper>
</div>

<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![Cantilever Robotic Gripper Jaw](./codes/crane_jib_moment_diagram.png)
  </TailwindWrapper>
</div>
