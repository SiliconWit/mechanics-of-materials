...
def main():
    ...
    frames = [
        ...
        {'type': 'text', 'text': 'Loading Diagram', 'text_color': '#405ab9', 'watermark': False, 'bg_color': bg_color},
        {'type': 'image', 'path': os.path.join(script_dir, 'crane_jib_loading_diagram.png'), 'watermark': True, 'bg_color': bg_color},
