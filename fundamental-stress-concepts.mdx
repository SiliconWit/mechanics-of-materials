...
1. <Badge text="Analyze" variant="tip" /> real-world mechatronic systems to identify critical components under stress
2. <Badge text="Define and calculate" variant="note" /> stress, strain, and material properties (Young's modulus, Poisson's ratio)
3. <Badge text="Apply" variant="tip" /> Hooke's Law to predict material behavior under loading
4. <Badge text="Solve" variant="caution" /> connecting rod stress problems during peak compression in crank-slider systems
